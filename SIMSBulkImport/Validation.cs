...
namespace SIMSBulkImport
{
    internal class Validation
    {
        ...
        {
            logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.Validation.IsValidEmail(email: " + email + ")");
        ...
        {
            logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.Validation.DeDuplicatation(dt: " + dt + ")");
        ...
        {
            logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.Validation.getColumnNames(table: " + table + ")");
            if (table != null)
            {
        ...
        protected internal static bool IsValidTelephone(string telephone)
        {
            logger.Log(LogLevel.Debug,
                "Trace:: SIMSBulkImport.Validation.IsValidTelephone(telephone: " + telephone + ")");
            var util = new RegexUtilities();
        ...
        {
            logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.Validation.IsBool(input: " + input + ")");
            bool result = false;
            try
            {
        ...
        {
            logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.Validation.IsDouble(input: " + input + ")");
            bool result = false;
            try
            {
                double t1;
        ...
        {
            logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.Validation.IsInt(input: " + input + ")");
            bool result = false;
            try
            {
                int t1;
