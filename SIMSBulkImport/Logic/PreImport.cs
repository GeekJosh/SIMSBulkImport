...
namespace SIMSBulkImport
{
    public class PreImport
    {
        ...
        public int GetImportFileRecordCount
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetImportFileRecordCount(GET)");
        ...
        public bool SetMatchIgnoreFirstRow
        {
            set
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.SetMatchIgnoreFirstRow(SET: " + value + ")");
        ...
        public bool GetMatchIgnoreFirstRow
        {
            ...
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.GETMatchIgnoreFirstRow(GET)");
        ...
        public DataTable SetImportDataset
        {
            ...
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.SetImportDataset(SET: " + value + ")");
        ...
        public DataTable CreateDataTable
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.CreateDataTable(GET)");
        ...
        public string SetMatchPersonID
        {
            ...
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.SetMatchPersonID(SET: " + value + ")");
                personId = value;
            }
        }
        ...
        public string SetMatchFirstname
        {
            ...
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.SetMatchFirstname(SET: " + value + ")");
                firstname = value;
            }
        }
        ...
        public string SetMatchSurname
        {
            ...
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.SetMatchSurname(SET: " + value + ")");
                surname = value;
            }
        }
        ...
        public string SetMatchEmail
        {
            set
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.SetMatchEmail(SET: " + value + ")");
                email = value;
            }
        }
        ...
        public string SetMatchTelephone
        {
            ...
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.SetMatchTelephone(SET: " + value + ")");
                telephone = value;
            }
        }
        ...
        public string SetMatchStaffcode
        {
            ...
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.SetMatchStaffcode(SET: " + value + ")");
                staffcode = value;
            }
        }
        ...
        public string SetMatchGender
        {
            set
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.SetMatchGender(SET: " + value + ")");
                gender = value;
            }
        }
        ...
        public string SetMatchTitle
        {
            set
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.SetMatchTitle(SET: " + value + ")");
                title = value;
            }
        }
        ...
        public string SetMatchUDF
        {
            set
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.SetMatchUDF(SET: " + value + ")");
                udf = value;
            }
        }
        ...
        public string SetMatchYear
        {
            set
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.SetMatchYear(SET: " + value + ")");
                year = value;
            }
        }
        ...
        public string SetMatchReg
        {
            set
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.SetMatchReg(SET: " + value + ")");
                reg = value;
            }
        }
        ...
        public string SetMatchHouse
        {
            set
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.SetMatchHouse(SET: " + value + ")");
                house = value;
            }
        }
        ...
        public string SetMatchTown
        {
            set
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.SetMatchTown(SET: " + value + ")");
                town = value;
            }
        }
        ...
        public string SetMatchPostcode
        {
            ...
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.SetMatchPostcode(SET: " + value + ")");
                postcode = value;
            }
        }
        ...
        public string SetMatchSIMSUDF
        {
            set
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.SetMatchSIMSUDF(SET: " + value + ")");
                simsUdf = value;
        ...
        public string SetMatchEmailLocation
        {
            ...
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.SetMatchEmailLocation(SET: " + value + ")");
                emailLocation = value;
            }
        }
        ...
        public string SetMatchEmailMain
        {
            ...
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.SetMatchEmailMain(SET: " + value + ")");
                emailMain = value;
            }
        }
        ...
        public string SetMatchEmailPrimary
        {
            ...
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.SetMatchEmailPrimary(SET: " + value + ")");
                emailPrimary = value;
            }
        }
        ...
        public string SetMatchEmailNotes
        {
            ...
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.SetMatchEmailNotes(SET: " + value + ")");
                emailNotes = value;
            }
        }
        ...
        public string SetMatchTelephoneLocation
        {
            ...
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.SetMatchTelephoneLocation(SET: " + value + ")");
        ...
        public string SetMatchTelephoneMain
        {
            ...
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.SetMatchTelephoneMain(SET: " + value + ")");
                telephoneMain = value;
            }
        }
        ...
        public string SetMatchTelephonePrimary
        {
            ...
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.SetMatchTelephonePrimary(SET: " + value + ")");
        ...
        public string SetMatchTelephoneNotes
        {
            ...
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.SetMatchTelephoneNotes(SET: " + value + ")");
        ...
        public string SetMatchTelephoneDevice
        {
            ...
            {
                logger.Log(LogLevel.Debug,
                    "Trace:: SIMSBulkImport.PreImport.SetMatchTelephoneDevice(SET: " + value + ")");
        ...
        public string GetMatchPersonID
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchPersonID(GET)");
                return personId;
            }
        }
        ...
        public string GetMatchFirstname
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchFirstname(GET)");
                return firstname;
            }
        }
        ...
        public string GetMatchSurname
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchSurname(GET)");
                return surname;
            }
        }
        ...
        public string GetMatchEmail
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchEmail(GET)");
                return email;
            }
        }
        ...
        public string GetMatchTelephone
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchTelephone(GET)");
                return telephone;
            }
        }
        ...
        public string GetMatchStaffcode
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchStaffcode(GET)");
                return staffcode;
            }
        }
        ...
        public string GetMatchGender
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchGender(GET)");
                return gender;
            }
        }
        ...
        public string GetMatchTitle
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchTitle(GET)");
                return title;
            }
        }
        ...
        public string GetMatchUDF
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchUDF(GET)");
                return udf;
            }
        }      
        ...
        public string GetMatchYear
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchYear(GET)");
                return year;
            }
        }
        ...
        public string GetMatchReg
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchReg(GET)");
                return reg;
            }
        }
        ...
        public string GetMatchHouse
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchHouse(GET)");
                return house;
            }
        }
        ...
        public string GetMatchTown
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchTown(GET)");
                return town;
            }
        }
        ...
        public string GetMatchPostcode
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchPostcode(GET)");
                return postcode;
            }
        }
        ...
        public string GetMatchEmailMain
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchEmailMain(GET)");
                return emailMain;
            }
        }
        ...
        public string GetMatchEmailPrimary
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchEmailPrimary(GET)");
                return emailPrimary;
            }
        }
        ...
        public string GetMatchEmailLocation
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchEmailLocation(GET)");
        ...
        public string GetMatchEmailNotes
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchEmailNotes(GET)");
                return emailNotes;
            }
        }
        ...
        public string GetMatchTelephoneMain
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchTelephoneMain(GET)");
        ...
        public string GetMatchTelephonePrimary
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchTelephonePrimary(GET)");
        ...
        public string GetMatchTelephoneNotes
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchTelephoneNotes(GET)");
        ...
        public string GetMatchTelephoneDevice
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchTelephoneDevice(GET)");
        ...
        public string GetMatchTelephoneLocation
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchTelephoneLocation(GET)");
        ...
        public string GetMatchSIMSUDF
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetMatchSIMSUDF(GET)");
                return simsUdf;
            }
        }
        ...
        public Interfaces.UserType SetUserType
        {
            set
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.SetUserType(SET: " + value + ")");
                userType = value;
        ...
        public Interfaces.UserType GetUserType
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetUserType(GET)");
                return userType;
            }
        }
        ...
        public string SetUserFilter
        {
            set
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.SetUserFilter(SET: " + value + ")");
                userFilter = value;
        ...
        public string GetUserFilter
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetUserFilter(GET)");
                return userFilter;
            }
        }
        ...
        public string SetUDFType
        {
            set
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.SetUDFType(SET: " + value + ")");
                udfType = value;
            }
        }
        ...
        public string GetUDFType
        {
            get
            {
                logger.Log(LogLevel.Debug, "Trace:: SIMSBulkImport.PreImport.GetUDFType(GET)");
                return udfType;
            }
        }
        ...
        {
            logger.Log(LogLevel.Debug,
                "Trace:: SIMSBulkImport.PreImport.AddToDataTable(recordupto: " + recordupto + ")");
            switch (Switcher.PreImportClass.GetUserType)
            {
                case Interfaces.UserType.Contact:
        ...
        {
            logger.Log(LogLevel.Debug,
                "Trace:: SIMSBulkImport.PreImport.GetStatus(personid: " + personid + ", email: " + email +
        ...
        {
            logger.Log(LogLevel.Debug,
                "Trace:: SIMSBulkImport.PreImport.IsNotDuplicate(personid: " + personid + ")");
        ...
        {
            logger.Log(LogLevel.Debug,
                "Trace:: SIMSBulkImport.PreImport.IsNotDuplicate(import: " + import + ", current: " + current +
                ")");
